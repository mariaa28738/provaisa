...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($numeroA < $numeroB) {
            ...
            echo "<p>Os valores são iguais: $numeroA = $numeroB.</p>";
        }
    } else {
        echo "<p>Nenhum número foi enviado :(. Volte ao formulário e insira novamente.</p>";
    }
    ?>
    <footer>
        Clique <a href="exercicio6.html">aqui</a> para voltar ao formulário.
    </footer>
</body>
</html>