...
<body>
    ...
    <h2>Resultado da Verificação de Maioridade</h2>
    <?php 
    // Verifica se o formulário foi enviado
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Recebe o nome e a idade do formulário
        $nome = htmlspecialchars($_POST['nome']); // Protege contra XSS
        $idade = intval($_POST['idade']); // Converte a idade para inteiro

        // Verifica se a idade é maior ou menor que 18 e exibe a mensagem personalizada
        if ($idade >= 18) {
        ...
        echo "<p>Os dados não foram enviados. Volte ao formulário e insira novamente.</p>";
    }
    ?>
    <footer>
        Clique <a href="exercicio9.html">aqui</a> para voltar ao formulário.
    </footer>
</body>
</html>